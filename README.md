...
- **[MCP_INSPECTOR_SETUP.md](src/main/java/com/chapman/edu/commissions/verticalslice/infrastructure/mcp/MCP_INSPECTOR_SETUP.md)** - Complete guide to using npx inspector
...
- **[MCP_SERVER_SETUP.md](src/main/java/com/chapman/edu/commissions/verticalslice/infrastructure/mcp/MCP_SERVER_SETUP.md)** - General MCP server setup
