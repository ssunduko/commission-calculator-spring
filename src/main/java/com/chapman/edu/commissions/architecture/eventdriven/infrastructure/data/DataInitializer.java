package com.chapman.edu.commissions.architecture.eventdriven.infrastructure.data;

import com.chapman.edu.commissions.architecture.eventdriven.domain.*;
import com.chapman.edu.commissions.architecture.eventdriven.features.calculations.CommissionCalculationRepository;
import com.chapman.edu.commissions.architecture.eventdriven.features.deals.DealRepository;
import com.chapman.edu.commissions.architecture.eventdriven.features.disputes.DisputeRepository;
...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        log.info("Initializing event-driven architecture sample data...");

        // Create sample users (must exist before deals due to FK constraint)
        User rep1 = createUser("evt_rep001", "evt_rep001@company.com", "Alice", "Johnson");
        User rep2 = createUser("evt_rep002", "evt_rep002@company.com", "Bob", "Smith");
        User rep3 = createUser("evt_rep003", "evt_rep003@company.com", "Carol", "Williams");
        ...
        log.info("Event-driven architecture sample data initialization completed! Created: 3 Users, 2 Plans, 6 Deals, 4 Calculations, 2 Disputes");
    }
