package com.chapman.edu.commissions.architecture.ddd.infrastructure.data;
...
import com.chapman.edu.commissions.architecture.ddd.domain.calculation.CommissionStatus;
import com.chapman.edu.commissions.architecture.ddd.domain.deal.Deal;
import com.chapman.edu.commissions.architecture.ddd.domain.deal.DealProduct;
...
import com.chapman.edu.commissions.architecture.ddd.domain.plan.BonusRule;
import com.chapman.edu.commissions.architecture.ddd.domain.plan.BonusType;
...
import com.chapman.edu.commissions.architecture.ddd.domain.plan.CommissionTier;
...
/**
 * Initializes DDD sample data in the database on application startup.
 */
@Component
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        log.info("Initializing DDD sample data...");

        // Create sample users (must exist before deals due to FK constraint)
        User rep1 = createUser("ddd_rep001", "ddd_rep001@company.com", "Alice", "Johnson");
        User rep2 = createUser("ddd_rep002", "ddd_rep002@company.com", "Bob", "Smith");
        User rep3 = createUser("ddd_rep003", "ddd_rep003@company.com", "Carol", "Williams");
        ...
        log.info("DDD sample data initialization completed! Created: 3 Users, 2 Plans, 6 Deals, 4 Calculations, 2 Disputes");
    }
